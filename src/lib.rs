...
pub use build_log::{
    ...
    LogSidecarFrameStream, LogSidecarStartEvent, LogSidecarTerminalEvent,
    LogSidecarWireVector, LOG_SIDECAR_FRAME_HEADER_BYTES, LOG_SIDECAR_FRAME_MAGIC,
    LOG_SIDECAR_FRAME_VERSION, LOG_SIDECAR_MAX_PAYLOAD_BYTES,
    LOG_SIDECAR_MAX_SHUTDOWN_MILLIS, LOG_SIDECAR_PROTOCOL,
